...
# 72 "./mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 84 "./mcc_generated_files/pin_manager.h"
...
void teclado_estado()
{
    ...
    switch (estado_teclado)
    {
      case n1:
              ...
              if ( (tecla!=0) && ((0 ? isdigit(tecla) : ((unsigned)(tecla)-'0') < 10)))
              {
              LATA0=1;
...
while (valor>0)
{
   _delay((unsigned long)((700)*(4000000/4000000.0)));
     teclado_estado();
     valor--;
 }
